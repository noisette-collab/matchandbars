const I18N = {
  en: {
    ...
    lead: "Find sports bars for football and rugby in 11 cities. Listings come from public guides. Always confirm the fixture with the venue.",
  ...
  es: {
    ...
    lead: "Bares para ver fútbol y rugby en 11 ciudades. Datos de guías públicas. Confirma siempre con el local.",
  ...
  zh: {
    ...
    kicker: "欧洲 + 纽约 · 测试版",
    title: "哪家酒吧在转播比赛？",
    lead: "11 座城市的足球与橄榄球酒吧。来自公开指南。请向店家确认当日赛事。",
